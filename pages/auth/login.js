...
const Login = () => {
  ...
  return (
    <div className="bg-gray-50 h-screen text-black lg:px-72 xl:px-96 flex flex-col justify-center items-center">
      ...
      >
        <div className="tabs mb-4 flex">
          <Link href="/auth/signup" className="tab flex-1 tab-lg tab-bordered">
            Sign Up
          </Link>
          <Link
            href="/auth/login"
